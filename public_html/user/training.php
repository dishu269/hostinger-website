        ...
        try {
            if ($type === 'post') {
                ...
                if (!empty($title) && !empty($body)) {
                    ...
                    $users_to_notify = $pdo->prepare('SELECT id FROM users WHERE id != ? AND role = "member"');
...
// Fetch all posts and their authors for the Q&A feed
...
// --- N+1 Query Optimization for comments ---
    ...
    <div class="card" style="margin-top: 12px;">
      ...
      <?php else: ?>
          ...
          <div style="border-left:3px solid #e5e7eb; padding-left:12px; margin:10px 0">
            ...
            <span style="color:#6b7280; font-size: 12px;"> - <?= date('M d, Y H:i', strtotime($c['created_at'])) ?></span>
